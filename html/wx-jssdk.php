...
<script type="text/javascript" src="http://47.94.208.182/base/js/jquery-1.10.1.min.js"></script>
  ...
  wx.ready(function () {
    ...
    function openWMap(longitude,latitude){
        wx.openLocation({
            ...
            infoUrl: 'http://coco8888.applinzi.com/html/my.php' // 在查看位置界面底部显示的超链接,可点击跳转
        });
    }
    	...
    	wx.onMenuShareTimeline({
            title: 'wh1806-天道酬勤', // 分享标题
            link: 'http://zeze88.applinzi.com/html/wx-jssdk.php', // 分享链接，该链接域名或路径必须与当前页面对应的公众号JS安全域名一致
            imgUrl: 'http://47.94.208.182/base/img/3.jpg', // 分享图标
            success: function () {
                    // 用户点击了分享后执行的回调函数
                    alert("谢谢分享到朋友圈")
                },
        ...
        wx.onMenuShareAppMessage({
            title: 'wh1806-daydayup', // 分享标题
            desc: '人均1W+', // 分享描述
            link: 'http://zeze88.applinzi.com/html/wx-jssdk.php', // 分享链接，该链接域名或路径必须与当前页面对应的公众号JS安全域名一致
            imgUrl: 'http://47.94.208.182/base/img/2.jpg', // 分享图标
        ...
        // 分享到 qq
        wx.onMenuShareQQ({
            title: '1806 two weeks get offer all', // 分享标题
            desc: '面试要自信冷静大方 ', // 分享描述
            link: 'http://zeze88.applinzi.com/html/wx-jssdk.php', // 分享链接
            imgUrl: 'http://47.94.208.182/base/img/1.jpg', // 分享图标
            success: function () {
            // 用户确认分享后执行的回调函数
                    alert("谢谢分享到QQ")
            },
        ...
        wx.onMenuShareQZone({
            ...
            link: 'http://zeze88.applinzi.com/html/wx-jssdk.php', // 分享链接
            imgUrl: 'http://47.94.208.182/base/img/4.jpg', // 分享图标
            success: function () {
            // 用户确认分享后执行的回调函数
                alert("谢谢分享到QQ空间")
            },
